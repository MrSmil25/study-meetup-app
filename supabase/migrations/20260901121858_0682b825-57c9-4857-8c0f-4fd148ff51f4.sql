DROP POLICY IF EXISTS "Authenticated bisa lihat avatar" ON storage.objects;
...
DROP POLICY IF EXISTS "User update avatar sendiri" ON storage.objects;
...
DROP POLICY IF EXISTS "User hapus avatar sendiri" ON storage.objects;
